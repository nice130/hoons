                ...
                <ul class="list-unstyled templatemo-accordion">
                    <li class="pb-3">
                        ...
                        <ul class="collapse show list-unstyled pl-3">
                            <li><a class="text-decoration-none" href="#">상의</a></li>
                            <li><a class="text-decoration-none" href="#">하의</a></li>
                        </ul>
                    </li>
                    <li class="pb-3">
                        <a class="collapsed d-flex justify-content-between h3 text-decoration-none" href="#">
                    ...
                    <li class="pb-3">
                        ...
                        <ul id="collapseThree" class="collapse list-unstyled pl-3">
                            ...
                            <li><a class="text-decoration-none" href="#">벨트</a></li>
                            <li><a class="text-decoration-none" href="#">양말</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
