...
<head>
    ...
    <!-- Css Styles -->
    <link rel="stylesheet" href="/resources/basic/css/bootstrap.min.css" type="text/css">
    <link rel="stylesheet" href="/resources/basic/css/font-awesome.min.css" type="text/css">
    <link rel="stylesheet" href="/resources/basic/css/elegant-icons.css" type="text/css">
    <link rel="stylesheet" href="/resources/basic/css/owl.carousel.min.css" type="text/css">
    <link rel="stylesheet" href="/resources/basic/css/slicknav.min.css" type="text/css">
    <link rel="stylesheet" href="/resources/basic/css/style.css" type="text/css">
</head>
...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="./index.html"><img src="/resources/basic/img/humberger/humberger-logo.png" alt=""></a>
        </div>
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                ...
                <li><a href="#">캐쥬얼</a></li>
                <li><a href="#">스트릿</a></li>
                <li class="dropdown"><a href="#">악세서리</a>
                    <ul class="dropdown__menu">
                        <li><a href="./categories-grid.html">반지</a></li>
                        <li><a href="./categories-list.html">귀걸이</a></li>
                        <li><a href="./single-post.html">벨트</a></li>
                    </ul>
                </li>
        ...
        <div class="humberger__menu__about">
            ...
            <img src="/resources/basic/img/humberger/humberger-about.jpg" alt="">
                                ...
                                <li><a href="#">정장</a>
                                    <div class="header__megamenu__wrapper">
                                        <div class="header__megamenu">
                                            ...
                                            <div class="header__megamenu__item">
                                                <div class="header__megamenu__item--pic set-bg"
                                                    data-setbg="/resources/basic/img/megamenu/p-2.jpg">
                                                    <div class="label">Vegan</div>
                                                </div>
                                                <div class="header__megamenu__item--text">
                                                    <h5><a href="#">How to Make a Milkshake With Any Ice Cream ...</a>
                                            ...
                                            <div class="header__megamenu__item">
                                                <div class="header__megamenu__item--pic set-bg"
                                                    data-setbg="/resources/basic/img/megamenu/p-3.jpg">
                                                    <div class="label">Vegan</div>
                                                </div>
                                                <div class="header__megamenu__item--text">
                                                    <h5><a href="#">How to Make a Milkshake With Any Ice Cream ...</a>
                                            ...
                                            <div class="header__megamenu__item">
                                                <div class="header__megamenu__item--pic set-bg"
                                                    data-setbg="/resources/basic/img/megamenu/p-4.jpg">
                                                    <div class="label">Vegan</div>
                                                </div>
                                                <div class="header__megamenu__item--text">
                                                    <h5><a href="#">How to Make a Milkshake With Any Ice Cream ...</a>
                                            ...
                                            <div class="header__megamenu__item">
                                                <div class="header__megamenu__item--pic set-bg"
                                                    data-setbg="/resources/basic/img/megamenu/p-5.jpg">
                                                    <div class="label">Vegan</div>
                                                </div>
                                                <div class="header__megamenu__item--text">
                                                    <h5><a href="#">How to Make a Milkshake With Any Ice Cream ...</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="header__logo">
                        <a href="./index.html"><img src="/resources/basic/img/logo.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3">
                    ...
                    <div class="row">
                        <div class="col-lg-6 p-0">
                            <div class="hero__inside__item hero__inside__item--wide set-bg"
                                data-setbg="/resources/basic/img/hero/hero-1.jpg">
                        ...
                        <div class="col-lg-3 col-md-6  p-0">
                            <div class="hero__inside__item hero__inside__item--small set-bg"
                                data-setbg="/resources/basic/img/hero/hero-2.jpg">
                                <div class="hero__inside__item__text">
                                    <div class="hero__inside__item--meta">
                                        <span>08</span>
                                        <p>Aug</p>
                            ...
                            <div class="hero__inside__item hero__inside__item--small set-bg"
                                data-setbg="/resources/basic/img/hero/hero-3.jpg">
                                <div class="hero__inside__item__text">
                                    <div class="hero__inside__item--meta">
                                        <span>08</span>
                                        <p>Aug</p>
                        ...
                        <div class="col-lg-3 col-md-6  p-0">
                            <div class="hero__inside__item set-bg" data-setbg="/resources/basic/img/hero/hero-4.jpg">
                                <div class="hero__inside__item__text">
                                    <div class="hero__inside__item--meta">
                                        <span>08</span>
                                        <p>Aug</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="categories__item set-bg" data-setbg="/resources/basic/img/categories/cat-1.jpg">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="categories__item set-bg" data-setbg="/resources/basic/img/categories/cat-2.jpg">
                        <div class="categories__hover__text">
                            <h5>Dinner</h5>
                            <p>28 articles</p>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="categories__item set-bg" data-setbg="/resources/basic/img/categories/cat-3.jpg">
                        <div class="categories__hover__text">
                            <h5>Dinner</h5>
                            <p>28 articles</p>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="categories__item set-bg" data-setbg="/resources/basic/img/categories/cat-4.jpg">
                        <div class="categories__hover__text">
                            <h5>Dinner</h5>
                            <p>28 articles</p>
                        </div>
                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="categories__post__item categories__post__item--large">
                            <div class="categories__post__item__pic set-bg"
                                data-setbg="/resources/basic/img/categories/categories-post/cp-1.jpg">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="categories__post__item">
                                    <div class="categories__post__item__pic small__item set-bg"
                                        data-setbg="/resources/basic/img/categories/categories-post/cp-2.jpg">
                                        <div class="post__meta">
                                            <h4>08</h4>
                                            <span>Aug</span>
                                        </div>
                                ...
                                <div class="categories__post__item">
                                    <div class="categories__post__item__pic set-bg"
                                        data-setbg="/resources/basic/img/categories/categories-post/cp-4.jpg">
                                        <div class="post__meta">
                                            <h4>08</h4>
                                            <span>Aug</span>
                                        </div>
                                ...
                                <div class="categories__post__item__plain set-bg"
                                    data-setbg="/resources/basic/img/categories/categories-post/cp-6.jpg">
                                    <div class="categories__post__item__text">
                                        <div class="post__meta">
                                            <h4>08</h4>
                                            <span>Aug</span>
                                ...
                                <div class="categories__post__item">
                                    <div class="categories__post__item__pic smaller__large set-bg"
                                        data-setbg="/resources/basic/img/categories/categories-post/cp-8.jpg">
                                        <div class="post__meta">
                                            <h4>08</h4>
                                            <span>Aug</span>
                                        </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="categories__post__item">
                                    <div class="categories__post__item__pic smaller__large set-bg"
                                        data-setbg="/resources/basic/img/categories/categories-post/cp-3.jpg">
                                        <div class="post__meta">
                                            <h4>08</h4>
                                            <span>Aug</span>
                                        </div>
                                ...
                                <div class="categories__post__item__small">
                                    <img src="/resources/basic/img/categories/categories-post/quote.png" alt="">
                                ...
                                <div class="categories__post__item">
                                    <div class="categories__post__item__pic smaller__large set-bg"
                                        data-setbg="/resources/basic/img/categories/categories-post/cp-5.jpg">
                                        <div class="post__meta">
                                            <h4>08</h4>
                                            <span>Aug</span>
                                        </div>
                                ...
                                <div class="categories__post__item">
                                    <div class="categories__post__item__pic set-bg"
                                        data-setbg="/resources/basic/img/categories/categories-post/cp-7.jpg">
                                        <div class="post__meta">
                                            <h4>08</h4>
                                            <span>Aug</span>
                                        </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="sidebar__item">
                            <div class="sidebar__about__item">
                                ...
                                <img src="/resources/basic/img/sidebar/sidebar-about.jpg" alt="">
                            ...
                            <div class="sidebar__feature__item">
                                ...
                                <div class="sidebar__feature__item__large set-bg"
                                    data-setbg="/resources/basic/img/sidebar/feature-post.jpg">
                            ...
                            <div class="sidebar__item__banner">
                                <img src="/resources/basic/img/sidebar/banner.jpg" alt="">
                            </div>
            ...
            <div class="footer__instagram">
                <div class="footer__instagram__avatar">
                    <div class="footer__instagram__avatar--pic">
                        <img src="/resources/basic/img/footer/instagram-avatar.jpg" alt="">
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-sm-4 col-6">
                        <div class="footer__instagram__item set-bg" data-setbg="/resources/basic/img/footer/ip-1.jpg"></div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4 col-6">
                        <div class="footer__instagram__item set-bg" data-setbg="/resources/basic/img/footer/ip-2.jpg"></div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4 col-6">
                        <div class="footer__instagram__item set-bg" data-setbg="/resources/basic/img/footer/ip-3.jpg"></div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4 col-6">
                        <div class="footer__instagram__item set-bg" data-setbg="/resources/basic/img/footer/ip-4.jpg"></div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4 col-6">
                        <div class="footer__instagram__item set-bg" data-setbg="/resources/basic/img/footer/ip-5.jpg"></div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4 col-6">
                        <div class="footer__instagram__item set-bg" data-setbg="/resources/basic/img/footer/ip-6.jpg"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="footer__text">
                        <div class="footer__logo">
                            <a href="#"><img src="/resources/basic/img/logo.png" alt=""></a>
                        </div>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <!-- Js Plugins -->
    <script src="/resources/basic/js/jquery-3.3.1.min.js"></script>
    <script src="/resources/basic/js/bootstrap.min.js"></script>
    <script src="/resources/basic/js/jquery.slicknav.js"></script>
    <script src="/resources/basic/js/owl.carousel.min.js"></script>
